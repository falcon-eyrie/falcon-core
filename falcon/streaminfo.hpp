...
class IStreamInfo {
  public:
    IStreamInfo(double stream_rate = IRREGULARSTREAM,
                std::string datatype = "none", std::string stream_name = "data")
    ...
    template <typename T> const T &parameters() const {
...
template <typename DATATYPE> class StreamInfo : public IStreamInfo {
  public:
    ...
    const typename DATATYPE::Parameters parameters() const {
        return std::any_cast<const typename DATATYPE::Parameters &>(
            parameters_);
    }
    ...
    void Finalize() override {
        ...
        auto prototype =
            std::make_unique<typename DATATYPE::Data>(this->parameters());
